...
chrpath='/home/lauren/MESA_dbGaP_55081/mesa_imputation_his/'
c='22'
refpop='1000g'
...
if(refpop == 'hrc'):
    ...
    snpfile = "/home/angela/1000GP_Phase3_combined/chr" + c + "_1000GP_Phase3_combined.legend.gz"
    for line in gzip.open(snpfile):
...
outdosage = gzip.open(chrpath + "UMich_dosages/chr" + c + ".maf" + str(mafthresh) + ".r2" + str(r2thresh) + "noambig.dosage.txt.gz","wb")
